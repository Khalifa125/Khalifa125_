...
I am a **Management Information Systems** student at **Modern Academy in Maadi** (2023–2027) with a strong focus on mobile application development. I build cross-platform apps using **Flutter & Dart** and have experience in **AI data annotation** for live machine learning pipelines.

I hold the **Microsoft Azure AI Fundamentals** certification and have shipped three complete mobile applications during a software development internship.

I am currently seeking **internship and entry-level opportunities** in mobile development, software engineering, and technology-driven roles.
...
Modern Academy in Maadi · 2023 – 2027
...
- Exploring backend integration with C# and .NET
- Preparing for the Samsung Innovation Campus (SIC8) program
...
| **Backend** | C#, .NET, SQL Server, MySQL |
| **Cloud & AI** | Microsoft Azure, Azure AI Fundamentals |
...
**CodeAlpha** · Remote · May 2026

- Developed **FitTracker**, a 7-screen fitness app with workout logging, nutrition tracking, step counter, achievements, and dark/light theme
- Built **StudyFlip**, an interactive flashcard app with deck management and animated card-flip transitions
- Created **Quotify**, a daily quotes app with custom branding and category browsing
- Delivered all three applications to a public GitHub repository within a single sprint

### Data Annotation Specialist
**MEEG / METI** · 2024

- Annotated multimodal datasets including images, video, and audio for live AI model training pipelines
- Maintained high accuracy on large daily volumes under tight production deadlines
- Collaborated with technical teams to identify and correct data inconsistencies
